...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    VenueListTableViewController *viewController = [[VenueListTableViewController alloc] initWithStyle:UITableViewStylePlain];
    UINavigationController *naviController = [[UINavigationController alloc] initWithRootViewController:viewController];
	naviController.navigationBar.tintColor = THEME_COLOR;
//    naviController.toolbarHidden = NO;
	naviController.toolbar.tintColor = THEME_COLOR;
